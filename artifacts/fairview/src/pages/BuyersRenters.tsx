...
export default function BuyersRenters() {
  const categories = [
    { title: "Properties for Sale", path: "/properties-for-sale", icon: Building2, color: "bg-blue-50 text-blue-600", image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&q=80" },
    { title: "Apartments for Rent", path: "/apartments-for-rent", icon: Home, color: "bg-orange-50 text-orange-600", image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&q=80" },
    { title: "Lands for Sale", path: "/lands-for-sale", icon: Landmark, color: "bg-green-50 text-green-600", image: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&q=80" },
